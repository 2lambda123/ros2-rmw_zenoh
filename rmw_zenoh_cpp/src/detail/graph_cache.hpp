...
public:
  ...
  static std::string node(size_t domain_id, const std::string &namespace_,
                          const std::string &name);

  static std::string publisher(size_t domain_id,
...
class PublishToken {
public:
  static bool put(z_owned_session_t *session, const std::string &token);

  static bool del(z_owned_session_t *session, const std::string &token);
};

///=============================================================================
class PublisherData final {
public:
  PublisherData(const char *topic, const char *node, const char *namespace_,
...
public:
  SubscriptionData(const char *topic, const char *node, const char *namespace_,
                   const char *type, rcutils_allocator_t *allocator);
...
public:
  uint64_t add_publisher(const char *topic, const char *node,
                         const char *namespace_, const char *type,
                         rcutils_allocator_t *allocator);

  void remove_publisher(uint64_t publisher_handle);

  uint64_t add_subscription(const char *topic, const char *node,
                            const char *namespace_, const char *type,
                            rcutils_allocator_t *allocator);
