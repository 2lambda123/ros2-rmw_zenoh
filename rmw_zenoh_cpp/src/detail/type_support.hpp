...
public:
  ...
  size_t get_estimated_serialized_size(const void *ros_message,
                                       const void *impl) const;

  bool serialize_ros_message(const void *ros_message,
                             eprosima::fastcdr::Cdr &ser,
                             const void *impl) const;

  bool deserialize_ros_message(eprosima::fastcdr::Cdr &deser, void *ros_message,
                               const void *impl) const;
