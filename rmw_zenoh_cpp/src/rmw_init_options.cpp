...
extern "C" {
//==============================================================================
/// Initialize given init options with the default values and implementation
/// specific values.
...
rmw_ret_t rmw_init_options_copy(const rmw_init_options_t *src,
  ...
  RMW_CHECK_TYPE_IDENTIFIERS_MATCH(src, src->implementation_identifier,
  ...
  rmw_ret_t ret = rmw_security_options_copy(&src->security_options, &allocator,
  ...
  ret = rmw_discovery_options_copy(&src->discovery_options, &allocator,
